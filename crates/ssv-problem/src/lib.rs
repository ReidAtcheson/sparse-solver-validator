...
pub use spec::{
    ...
    MAX_DIA_EDGE_DIAGONALS, MAX_DIMENSION, MAX_FRACTIONAL_BITS, MAX_NONSYMMETRIC_ROW_NONZEROS,
    MAX_PERIOD_BITS, MatrixSpec, OffDiagonalValues, ProblemError, ProblemSchema, ProblemTemplate,
    PublicEvaluationTerms, RequestedOutput, RhsSpec, SymmetricDiaEdge, TemplateSchema,
};
