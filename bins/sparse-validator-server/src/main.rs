...
use ssv_direct::maximum_artifact_bytes;
...
async fn main() -> Result<()> {
    match Cli::parse().command {
        ...
        Command::Serve {
            ...
            let structural_proof_limit = maximum_artifact_bytes(maximum_solution_elements)
                .context("maximum-solution-elements exceeds the direct backend's byte limit")?;
